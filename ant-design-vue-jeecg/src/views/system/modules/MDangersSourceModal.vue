...
<!--          <a-input placeholder="请输入危险类型" v-decorator="['type', validatorRules.type ]" />-->
          <a-select v-decorator="[ 'type', {rules: [{ required: true, message: '请选择危险类型'}]} ]" placeholder="请选择危险类型">
            <a-select-option :value="0">一般</a-select-option>
            <a-select-option :value="1">重大</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
...
<!--          <a-input placeholder="请输入等级" v-decorator="['level', validatorRules.level ]" />-->
          <a-select v-decorator="[ 'level', {rules: [{ required: true, message: '请选择等级'}]} ]" placeholder="请选择等级">
            <a-select-option :value="0">无</a-select-option>
            <a-select-option :value="1">Ⅳ级</a-select-option>
            <a-select-option :value="2">Ⅲ级</a-select-option>
            <a-select-option :value="3">Ⅱ级</a-select-option>
            <a-select-option :value="4">Ⅰ级</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
...
<!--          <a-input placeholder="请输入目前状态" v-decorator="['status', validatorRules.status ]" />-->
          <a-select v-decorator="[ 'status', {rules: [{ required: true, message: '请选择目前状态'}]} ]" placeholder="请选择目前状态">
            <a-select-option :value="0">受控</a-select-option>
            <a-select-option :value="1">非受控</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
